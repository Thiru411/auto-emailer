...
<html lang="en">
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted"><a href="<?php echo base_url()?>client/manage-alert-list" style="text-decoration:none; color: inherit;">Manage Alerts List</a></li>
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item">
												<span class="bullet bg-gray-400 w-5px h-2px"></span>
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted"><a href="<?php echo base_url()?>client/manage-alert-list" style="text-decoration:none; color: inherit;">Alerts List</a></li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-title">
												...
												<div class="d-flex align-items-center position-relative my-1">
													...
													<!--end::Svg Icon-->
													<label>From</label>
													<input type="text"  class="form-control form-control-solid w-350px ps-14 from" id="datepicker"  value="MM-DD-YYYY" />
													<label>To</label>
													<input type="text"  class="form-control form-control-solid w-350px ps-14 to" id="datepicker1"  value="MM-DD-YYYY" />
													<button type="submit" class="btn btn-primary" name="datefunction" id="datefunction">Submit</button>
												</div>
												<!--end::Search-->
											</div>
											<!--begin::Card title-->
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
												...
												<thead>
													...
													<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                                        ...
                                                        <th class="min-w-125px">Triggered Stop Date</th>
														<th class="min-w-100px">Triggered Actions</th>
													</tr>
													<!--end::Table row-->
												</thead>
												<!--end::Table head-->
												<?=$alert_list_details?>
												<!--begin::Table body-->
												<tbody class="text-gray-600 fw-semibold attachtable">
													<!--begin::Table row-->
													<!--end::Table row-->
													<!--begin::Table row-->
		...
		<script src="<?=base_url()?>assets/js/custom/apps/user-management/users/list.js"></script>
		...
		<script>
		$('#datefunction').click(function(){
			var from=$('.from').val();
			var to=$('.to').val();
			$.ajax({
				url : AJAX_URL+'client/manage_alert_list_by_date_v1',
				type: "POST",
				data: {from:from, to:to},
				success: function(data)
				{
						$('.attachtable').html(data);
				}
			});
		});
		</script>
