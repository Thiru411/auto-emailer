...
<html lang="en">
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Alert List</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted"><a href="<?php echo base_url()?>client/manage-alert" style="text-decoration:none; color: inherit;">Manage Alerts</a></li>
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item">
												<span class="bullet bg-gray-400 w-5px h-2px"></span>
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted"><a href="<?php echo base_url()?>client/manage-alert" style="text-decoration:none; color: inherit;">Alerts</a></li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-title">
												...
												<div class="d-flex align-items-center position-relative my-1">
													...
													<!--end::Svg Icon-->
													<input type="text" data-kt-alert-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Alerts" />
												</div>
												<!--end::Search-->
											</div>
											<!--begin::Card title-->
											...
											<div class="card-toolbar">
												...
												<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
													...
													<!--end::Svg Icon-->Add Alerts</button>
													<!--end::Add user-->
												</div>
												<!--end::Toolbar-->
												<!--begin::Group actions-->
												...
												<div class="modal fade" id="kt_modal_add_user" tabindex="-1" aria-hidden="true" >
													...
													<div class="modal-dialog modal-dialog-centered mw-650px">
														...
														<div class="modal-content">
															<!--begin::Modal header-->
															<form id="kt_modal_add_user_form1" class="form" action="#" data-kt-redirect="<?=base_url()?>client/manage-alert">

															<div class="modal-header d-block" id="kt_modal_add_user_header">
																<!--begin::Modal title-->
																<h2 class="fw-bold">Add Alert</h2> 
																
																<!--end::Modal title-->
																<!--begin::Close-->
																<div class="btn btn-icon btn-sm btn-active-icon-primary add__alert__CrossMark" >
																	<!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
																	<span class="svg-icon svg-icon-1">
																		<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
																			<rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1" transform="rotate(-45 6 17.3137)" fill="currentColor" />
																			<rect x="7.41422" y="6" width="16" height="2" rx="1" transform="rotate(45 7.41422 6)" fill="currentColor" data-bs-dismiss="modal"/>
																		</svg>
																	</span>
																	<!--end::Svg Icon-->
																</div>
															...
															<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
																<!--begin::Form-->
																	...
																	<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<select name="customer" data-control="select2" data-placeholder="Select a Customer" data-hide-search="true" class="form-select form-select-solid fw-bold">
																			<?=$customer?>
																			</select>
																			<!--end::Input-->
																		</div>
																		...
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">Select Projects</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<select name="projetcs" data-control="select2" data-placeholder="Select a projects" data-hide-search="true" class="form-select form-select-solid fw-bold">
																			<?=$projects?>
																...
																<label class="required fw-semibold fs-6 mb-2"> To </label>
																	...
																	<select class="form-select-solid fw-bold form-select js-example-basic-multiple to" data-control="select2" aria-label="Default select example" id="to" name="to" multiple="multiple">
																		  <?=$users?>

																		</select></div>
																	<div class="fv-row mb-7">
																	<label class="required fw-semibold fs-6 mb-2"> CC </label>
																	<select class="form-select-solid fw-bold form-select js-example-basic-multiple cc" data-control="select2" aria-label="Default select example" id="cc" name="cc" multiple="multiple">
																		  <?=$users?>
																		</select></div>
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="date" name="start_date" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="example@domain.com" value="smith@kpmg.com" />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																		...
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">Alert Message</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="alert_message" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Alert message"  />
																			<!--end::Input-->
																		</div>
																	...
																	<div class="text-center pt-15">
																		<button type="reset" class="btn btn-light me-3" id="kt_modal_add_customer_cancel1" data-kt-users-modal-action="cancel">Discard</button>
																		<button type="submit" class="btn btn-primary" id="kt_modal_add_customer_submit1" data-kt-users-modal-action="submit">
																			<span class="indicator-label">Submit</span>
																			<span class="indicator-progress">Please wait...
																			<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
																		</button>
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
												...
												<thead>
													...
													<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-125px">Alert Status</th>
		...
		<script src="<?=base_url()?>assets/js/custom/apps/customers/client/add.js"></script>
		<script src="<?=base_url()?>assets/js/custom/apps/customers/client/table.js"></script>
