										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-title">
												...
												<div class="d-flex align-items-center position-relative my-1">
													...
													<!--end::Svg Icon-->
													<input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Client" />
												</div>
												<!--end::Search-->
											</div>
											<!--begin::Card title-->
											...
											<div class="card-toolbar">
												...
												<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
													...
													<!--end::Svg Icon-->Add Client</button>
													<!--end::Add user-->
												</div>
												<!--end::Toolbar-->
												<!--begin::Group actions-->
															...
															<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
																...
																<form id="kt_modal_add_user_form" class="form" action="#">
																	...
																	<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																		...
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">POC</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="user_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Full name"  />
																			<!--end::Input-->
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="number" name="user_email" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="1234567899"  />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="user_email" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Address"  />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="user_email" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="County Name" />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
												...
												<tbody class="text-gray-600 fw-semibold">
													...
													<tr>
														...
														<td class="d-flex align-items-center">
															...
															<div class="d-flex flex-column">
																<a href="<?=base_url()?>users/view" class="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
														...
														<td class="text-end">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<div class="menu-item px-3">
																	<a href="<?=base_url()?>users/view" class="menu-link px-3">Edit</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
													...
													<tr>
														...
														<td class="d-flex align-items-center">
															...
															<!--begin::User details-->
															<div class="d-flex flex-column">
																<a href="<?=base_url()?>users/view" class="text-gray-800 text-hover-primary mb-1">Melody Macy</a>
													...
													<tr>
														...
														<td class="d-flex align-items-center">
															...
															<!--begin::User details-->
															<div class="d-flex flex-column">
																<a href="<?=base_url()?>users/view" class="text-gray-800 text-hover-primary mb-1">Max Smith</a>
													...
													<tr>
														...
														<td class="d-flex align-items-center">
															...
															<!--begin::User details-->
															<div class="d-flex flex-column">
																<a href="<?=base_url()?>users/view" class="text-gray-800 text-hover-primary mb-1">Sean Bean</a>
													...
													<tr>
														...
														<td class="d-flex align-items-center">
															...
															<!--begin::User details-->
															<div class="d-flex flex-column">
																<a href="<?=base_url()?>users/view" class="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
													...
													<tr>
														...
														<td class="d-flex align-items-center">
															...
															<!--begin::User details-->
															<div class="d-flex flex-column">
																<a href="<?=base_url()?>users/view" class="text-gray-800 text-hover-primary mb-1">Mikaela Collins</a>
													...
													<tr>
														...
														<td class="d-flex align-items-center">
															...
															<!--begin::User details-->
															<div class="d-flex flex-column">
																<a href="<?=base_url()?>users/view" class="text-gray-800 text-hover-primary mb-1">Francis Mitcham</a>
													...
													<tr>
														...
														<td class="d-flex align-items-center">
															...
															<!--begin::User details-->
															<div class="d-flex flex-column">
																<a href="<?=base_url()?>users/view" class="text-gray-800 text-hover-primary mb-1">Olivia Wild</a>
													...
													<tr>
														...
														<td class="d-flex align-items-center">
															...
															<!--begin::User details-->
															<div class="d-flex flex-column">
																<a href="<?=base_url()?>users/view" class="text-gray-800 text-hover-primary mb-1">Neil Owen</a>
													...
													<tr>
														...
														<td class="d-flex align-items-center">
															...
															<!--begin::User details-->
															<div class="d-flex flex-column">
																<a href="<?=base_url()?>users/view" class="text-gray-800 text-hover-primary mb-1">Dan Wilson</a>
													...
													<tr>
														...
														<td class="d-flex align-items-center">
															...
															<!--begin::User details-->
															<div class="d-flex flex-column">
																<a href="<?=base_url()?>users/view" class="text-gray-800 text-hover-primary mb-1">Emma Bold</a>
													...
													<tr>
														...
														<td class="d-flex align-items-center">
															...
															<!--begin::User details-->
															<div class="d-flex flex-column">
																<a href="<?=base_url()?>users/view" class="text-gray-800 text-hover-primary mb-1">Ana Crown</a>
													...
													<tr>
														...
														<td class="d-flex align-items-center">
															...
															<!--begin::User details-->
															<div class="d-flex flex-column">
																<a href="<?=base_url()?>users/view" class="text-gray-800 text-hover-primary mb-1">Robert Doe</a>
													...
													<tr>
														...
														<td class="d-flex align-items-center">
															...
															<!--begin::User details-->
															<div class="d-flex flex-column">
																<a href="<?=base_url()?>users/view" class="text-gray-800 text-hover-primary mb-1">John Miller</a>
													...
													<tr>
														...
														<td class="d-flex align-items-center">
															...
															<!--begin::User details-->
															<div class="d-flex flex-column">
																<a href="<?=base_url()?>users/view" class="text-gray-800 text-hover-primary mb-1">Lucy Kunic</a>
