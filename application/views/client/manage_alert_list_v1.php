...
<html lang="en">
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">View Alert List</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted"><a href="<?php echo base_url()?>client/manage-alert-list-view" style="text-decoration:none; color: inherit;">Manage Alerts List</a></li>
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item">
												<span class="bullet bg-gray-400 w-5px h-2px"></span>
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted"><a href="<?php echo base_url()?>client/manage-alert-list-view" style="text-decoration:none; color: inherit;">View Alerts List</a></li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
												...
												<thead>
													...
													<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                                        ...
                                                        <th class="min-w-125px">Mail Send Date</th>
                                                        <th class="min-w-125px">Mail Status</th>
		...
		<script src="<?=base_url()?>assets/js/custom/apps/user-management/users/list/table1.js"></script>
		...
		$('#datefunction').click(function(){
			...
			var to=$('.to').val();
			$.ajax({
				url : AJAX_URL+'client/manage_alert_list_by_date1',
				type: "POST",
