											...
											<div class="card mb-5 mb-xl-8">
												...
												<div class="card-body">
													...
													<div class="d-flex flex-center flex-column py-5">
														<!--begin::Avatar-->
														<div class="symbol symbol-100px symbol-circle mb-7" style="border: 1px solid;padding: 10px;border-radius: 30px;background: #009ef7;color: #ffffff;font-size: 20px;">
														<?php echo substr($this->session->userdata("admin_session_name"), 0, 1);?>

														</div>
														<!--end::Avatar-->
														<!--begin::Name-->
														<a href="<?=base_url()?>users/view" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3"><?=$name?></a>
														<!--end::Name-->
														<!--begin::Position-->
														<div class="mb-9">
															<!--begin::Badge-->
															<div class="badge badge-lg badge-light-primary d-inline"><?=$user_role?></div>
															<!--begin::Badge-->
														</div>
														<!--end::Position-->
														<!--begin::Info-->
														...
														<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_user_header" data-kt-scroll-wrappers="#kt_modal_update_user_scroll" data-kt-scroll-offset="300px">
															...
															<div id="kt_modal_update_user_user_info" class="collapse show">
																...
																<div class="fv-row mb-7">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="hidden" class="form-control form-control-solid" placeholder="" name="user_id"  value='<?=base64_decode($this->uri->segment(3))?>' />
																	<input type="text" class="form-control form-control-solid" placeholder="" name="name"  value='<?=$name?>' />
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
																<!--begin::Input group-->
																<div class="fv-row mb-7">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="email" class="form-control form-control-solid" placeholder="" name="email" value="<?=$email?>" />
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
																<!--begin::Input group-->
																<div class="fv-row mb-7">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" class="form-control form-control-solid" placeholder="" name="description" value="<?=$description?>" />
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
																<!--begin::Input group-->
															...
															<div id="kt_modal_update_user_address" class="collapse show">
																...
																<div class="d-flex flex-column mb-7 fv-row">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input class="form-control form-control-solid" placeholder="" name="address1" value="<?=$address?>" />
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
																<!--begin::Input group-->
																<div class="d-flex flex-column mb-7 fv-row">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input class="form-control form-control-solid" placeholder="" name="address2" value="<?=$address2?>" />
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
																<!--begin::Input group-->
																<div class="d-flex flex-column mb-7 fv-row">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input class="form-control form-control-solid" placeholder="" name="city" value="<?=$town?>" />
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
																<!--begin::Input group-->
																<div class="row g-9 mb-7">
																	...
																	<div class="col-md-6 fv-row">
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input class="form-control form-control-solid" placeholder="" name="state" value="<?=$state?>" />
																		<!--end::Input-->
																	</div>
																	<!--end::Col-->
																	<!--begin::Col-->
																	<div class="col-md-6 fv-row">
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input class="form-control form-control-solid" placeholder="" name="postcode" value="<?=$post_code?>" />
																		<!--end::Input-->
																	</div>
																	<!--end::Col-->
																</div>
												...
												<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
													...
													<div class="fw-bold d-flex flex-column justify-content-center mb-5">
														...
														<div class="d-flex flex-center" data-kt-add-auth-action="qr-code">
															<img src="<?=base_url()?>assets/media/misc/qr.png" alt="Scan this QR code" />
														</div>
														<!--end::QR code-->
														<!--begin::Text code-->
