								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted"><a href="<?php echo base_url()?>users/list" style="text-decoration:none; color: inherit;">User Management</a></li>
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item">
												<span class="bullet bg-gray-400 w-5px h-2px"></span>
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted"><a href="<?php echo base_url()?>users/list" style="text-decoration:none; color: inherit;">Users</a></li>
													...
													<div class="modal-dialog modal-dialog-centered mw-650px">
														...
														<div class="modal-content">
															...
															<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
																<!--begin::Form-->
																<form id="kt_modal_add_user_form" class="form" action="#" data-kt-redirect="<?=base_url()?>users/list">
																	<!--begin::Scroll-->
																	<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="user_mobile" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Enter Phone Number"  />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="user_address" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Address"  />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<select name="user_country" aria-label="Select a County" data-control="select2" data-placeholder="Select a County..." data-dropdown-parent="#kt_modal_add_user" class="form-select form-select-solid fw-bold">
																		<?=$contry?>																		
																	</select>
																			<!--end::Input-->
																		</div>
																		...
																		<div class="fv-row mb-7">
																			...
																			<select name="roles" aria-label="Select a County" data-control="select2" data-placeholder="Select a Role..." data-dropdown-parent="#kt_modal_add_user" class="form-select form-select-solid fw-bold">
...
function updatestatus(id,status){
	Swal.fire({
                text: "Do you want to inactive users?",
                icon: "warning",
                ...
                if (result.value) {
					$.ajax({
            url: AJAX_URL+'users/actinact',
            type: 'post',
            data:{id:id,status:status},
            beforeSend: function(){
            },
            success: function(resp){
				window.location.assign(AJAX_URL+'users/list');
...
$('.active').click(function(){
	...
	$.ajax({
            ...
            type: 'post',
            data:{user_status:active,table:'mst_users',fieldName:'user_status'},
            beforeSend: function(){
            },
            success: function(resp){
				$('#attt').html(resp);
