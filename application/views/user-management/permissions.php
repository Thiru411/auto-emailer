...
<html lang="en">
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_permissions_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
														<th class="min-w-100">Users</th>
														<th class="min-w-100">Clients</th>
														<th class="min-w-100">Projects</th>
										...
										<div class="modal-dialog modal-dialog-centered mw-650px">
											...
											<div class="modal-content">
												...
												<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
													<!--begin::Form-->
													<form id="kt_modal_add_permission_form" class="form" action="#" data-kt-redirect="<?=base_url()?>/users/permissions">
														<!--begin::Input group-->
														<div class="fv-row mb-7">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<select class="form-select  users" aria-label="Default select example" id="users" name="users1" >
																		  <?=$users?>
														...
														<div class="fv-row mb-7">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<select class="form-select js-example-basic-multiple clients" aria-label="Default select example" id="clients" name="clients" multiple="multiple">
																		  <?=$client?>
														</select>															<!--end::Input-->
														</div>
														...
														<div class="fv-row mb-7">
															<!--begin::Label-->
															<label class="fs-6 fw-semibold form-label mb-2">
																<span class="required">Select Projects</span>
																<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-html="true" data-bs-content="Permission names is required to be unique."></i>
															</label>
															<!--end::Label-->
															<!--begin::Input-->
															<select class="form-select js-example-basic-multiple projects" id="projects" aria-label="Default select example" name="projects"multiple="multiple">
																		  <?=$projects?>
		...
		<script src="<?=base_url()?>assets/js/custom/apps/user-management/permissions/add-permission.js"></script>
