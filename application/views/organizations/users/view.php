								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_63de8ad730185">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_63de8ad730185" data-allow-clear="true">
																<option></option>
											...
											<div class="card mb-5 mb-xl-8">
												...
												<div class="card-body">
													...
													<div class="d-flex flex-center flex-column py-5">
														...
														<!--end::Avatar-->
														<!--begin::Name-->
														<a href="<?=base_url()?>users/view" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3">Emma Smith</a>
														<!--end::Name-->
														<!--begin::Position-->
														<div class="mb-9">
															<!--begin::Badge-->
																...
																<table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_users_logs">
																	...
																	<tbody>
																		...
																		<tr>
																			...
																			<!--end::Badge=-->
																			<!--begin::Status=-->
																			<td>POST /v1/invoices/in_3017_3610/payment</td>
																			<!--end::Status=-->
																			<!--begin::Timestamp=-->
																		...
																		<tr>
																			...
																			<!--end::Badge=-->
																			<!--begin::Status=-->
																			<td>POST /v1/customer/c_63de8ad736c71/not_found</td>
																			<!--end::Status=-->
																			<!--begin::Timestamp=-->
																		...
																		<tr>
																			...
																			<!--end::Badge=-->
																			<!--begin::Status=-->
																			<td>POST /v1/invoices/in_3055_1606/payment</td>
																			<!--end::Status=-->
																			<!--begin::Timestamp=-->
																		...
																		<tr>
																			...
																			<!--end::Badge=-->
																			<!--begin::Status=-->
																			<td>POST /v1/customer/c_63de8ad736c74/not_found</td>
																			<!--end::Status=-->
																			<!--begin::Timestamp=-->
