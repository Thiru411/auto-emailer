...
<html lang="en">
	...
	<body id="kt_body" class="app-blank bgi-size-cover bgi-position-center">
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			<!--begin::Page bg image-->
			<style>body { background-image: url('<?=base_url()?>assets/media/auth/bg10.jpeg'); } [data-bs-theme="dark"] body { background-image: url('<?=base_url()?>assets/media/auth/bg10-dark.jpeg'); }</style>
			<!--end::Page bg image-->
					...
					<div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
						...
						<div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
							...
							<div class="d-flex flex-center flex-column-fluid pb-15 pb-lg-20">
								<!--begin::Form-->
								<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="<?=base_url()?>dashboard/index" action="#">
									<!--begin::Heading-->
									...
									<a href="<?=base_url()?>demo1/dist/authentication/layouts/overlay/sign-up.html" class="link-primary">Sign up</a></div>-->
									<!--end::Sign up-->
								</form>
								<!--end::Form-->
							</div>
