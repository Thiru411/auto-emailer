...
<html lang="en">
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Client List</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted"><a href="<?php echo base_url()?>customers/list" style="text-decoration:none; color: inherit;">Client</a></li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<a href="#" class="btn btn-sm fw-bold btn-primary d-none" >Create</a> <!--data-bs-toggle="modal" data-bs-target="#akt_modal_create_app"-->
										<!--end::Primary button-->
									</div>
									<!--end::Actions-->
								</div>
									...
									<div class="card">
										...
										<div class="card-body pt-0">
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												...
												<!--end::Table head-->
												<!--begin::Table body-->
												<tbody class="fw-semibold text-gray-600" id="attt">
												<?=$output?>	
												</tbody>
												<!--end::Table body-->
											</table>
									...
									<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
										...
										<div class="modal-dialog modal-dialog-centered" style="max-width:850px !important">
											...
											<div class="modal-content">
												<!--begin::Form-->
												<form class="form" action="#" id="kt_modal_add_customer_form" data-kt-redirect="<?=base_url()?>customers/list">
													<!--begin::Modal header-->
													<div class="modal-header" id="kt_modal_add_customer_header">
														<!--begin::Modal title-->
														<h2 class="fw-bold">Add a Client</h2>
														<!--end::Modal title-->
														<!--begin::Close-->
													...
													<div class="modal-body py-10 px-lg-17">
														...
														<!--begin::Input group-->
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<select name="owner" aria-label="Select a Country" data-control="select2" data-placeholder="Select Owner Email Id..." data-dropdown-parent="#kt_modal_add_customer" class="form-select form-select-solid fw-bold">
																			<?=$users?>
																			</select>
																	</div>
																	<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">POC Name</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="poc" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="POC"  />
																			<!--end::Input-->
																		</div>
																		<!--begin::Input group-->
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">POC Phone Number</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="pocnumber" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="POC Number"  />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																		<div class="fv-row row mb-7 customer_records">
																			...
																			<div class="d-flex">
																				<input name="customer_email1" class="form-control form-control-solid userType__Email" type="email" placeholder="email">
																		...
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class=" fw-semibold fs-6 mb-2">Alternate contact number</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="customer_num" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Enter Phone Number"  />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																		<!--begin::Input group-->
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="customer_address" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Address"  />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="country_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="County Name" />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
															<!--begin::Billing toggle-->
															<div class="fw-bold fs-3 rotate collapsible mb-7" data-bs-toggle="collapse" href="#kt_modal_add_customer_billing_info" role="button" aria-expanded="false" aria-controls="kt_customer_view_details">Shipping Information(optional)
										...
										<div class="modal-dialog modal-dialog-centered mw-650px">
											...
											<div class="modal-content">
												...
												<div class="modal-header">
													<!--begin::Modal title-->
													<h2 class="fw-bold">Export Clients</h2>
													<!--end::Modal title-->
													<!--begin::Close-->
		...
		<div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'lg': '900px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_activities_toggle" data-kt-drawer-close="#kt_activities_close">
			<div class="card shadow-none border-0 rounded-0">
								...
								<div class="timeline-content mb-10 mt-n1">
									...
									<div class="overflow-auto pb-5">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
											<!--begin::Title-->
											<a href="<?=base_url()?>demo1/dist/apps/projects/project.html" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Meeting with customer</a>
											<!--end::Title-->
											<!--begin::Label-->
											...
											<!--end::Progress-->
											<!--begin::Action-->
											<a href="<?=base_url()?>demo1/dist/apps/projects/project.html" class="btn btn-sm btn-light btn-active-light-primary">View</a>
											<!--end::Action-->
										</div>
										<!--end::Record-->
										<!--begin::Record-->
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
											<!--begin::Title-->
											<a href="<?=base_url()?>demo1/dist/apps/projects/project.html" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Project Delivery Preparation</a>
											<!--end::Title-->
											<!--begin::Label-->
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												...
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
													<a href="<?=base_url()?>demo1/dist/apps/projects/project.html" class="fs-6 text-hover-primary fw-bold">Finance KPI App Guidelines</a>
													<!--end::Desc-->
													<!--begin::Number-->
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="<?=base_url()?>demo1/dist/apps/projects/project.html" class="w-30px me-3" src="<?=base_url()?>assets/media/svg/files/doc.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
											...
											<div class="d-flex flex-aligns-center">
												<!--begin::Icon-->
												<img alt="<?=base_url()?>demo1/dist/apps/projects/project.html" class="w-30px me-3" src="<?=base_url()?>assets/media/svg/files/css.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
				...
				<div class="card-footer py-5 text-center" id="kt_activities_footer">
					<a href="<?=base_url()?>demo1/dist/pages/user-profile/activity.html" class="btn btn-bg-body text-primary">View All Activities
				...
				<div class="card-body hover-scroll-overlay-y h-400px pt-5">
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="<?=base_url()?>demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">Iblender</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="<?=base_url()?>demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">SmartCleaner</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="<?=base_url()?>demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">CameraMaxr</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="<?=base_url()?>demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">$D Printer</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="<?=base_url()?>demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">MotionWire</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="<?=base_url()?>demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">Samsung</a>
		...
		<?php $this->load->view("inc/customers-footer-scripts");?>
		<script src="<?=base_url()?>assets/js/custom/apps/customers/add.js"></script>
		<script src="<?=base_url()?>assets/js/custom/apps/customers/list/table.js"></script>
	...
	function updatestatus(id,status){
		if(status==1){
			var message ='Do you want to Active user?';
			var btnnn='Yes, Active it';

		}else{
			var message ='Do you want to InActive user?';
...
$('.active').click(function(){
	...
	$.ajax({
            ...
            type: 'post',
            data:{user_status:active,table:'mst_customer',fieldName:'customer_status'},
            beforeSend: function(){
            },
            success: function(resp){
				$('#attt').html(resp);
